...
3. **Specialized agents** implement (`@ux`, `@content`, `@frontend`, `@styling`, `@backend`, `@db-dev`, …) según **perfil activo** (`STACK.md` si existe en el repo; si no, lo indicado en el mensaje del usuario)
