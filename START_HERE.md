...
| 8 | **`.cursor/commands/delegate-*.md`** | Delegación rápida por dominio (`backend`, `ui`, `db`, `review`, `orchestrator`). |
...
- **Delegación directa por rol:** comandos **`/delegate-backend`**, **`/delegate-ui`**, **`/delegate-db`**, **`/delegate-review`**, **`/delegate-orchestrator`**.
